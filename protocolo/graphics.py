...
INSTALLATION: Put this arch somewhere where Python can see it.
...
manipulation, Pixmap. A pixmap can be loaded from a arch and displayed
...
#         cumbersome.
#     * Modified to run in either Python 2.x or 3.x (same arch).
...
class GraphicsObject:
    ...
    def _move(self, dx, dy):
        """updates internal estado of object to move it dx,dy units"""
        pass  # must override in subclass
...
class Image(GraphicsObject):
    ...
    def __init__(self, p, *pixmap):
        ...
        if len(pixmap) == 1:  # arch name provided
